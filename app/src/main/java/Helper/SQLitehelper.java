...
//            " INTEGER PRIMARY KEY AUTOINCREMENT," + NAME + " TEXT NOT NULL,"+BALANCE+" TEXT NOT NULL);";
//    //Constructor
...
//        contentValues.put(SQLitehelper.NAME, employeeModelClass.getName());
//        contentValues.put(SQLitehelper.BALANCE, employeeModelClass.getEmail());
...
//        ContentValues contentValues = new ContentValues();
//        contentValues.put(SQLitehelper.NAME,employeeModelClass.getName());
//        contentValues.put(SQLitehelper.EMAIL,employeeModelClass.getEmail());
//        sqLiteDatabase = this.getWritableDatabase();
